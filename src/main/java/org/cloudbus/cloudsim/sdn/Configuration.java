...
public class Configuration {
	...
	//*/
	//////////////////////////// Default value
	public static double CPU_SIZE_MULTIPLY = 1;	// Multiply all the CPU size for scale. Default =1 (No amplify)
...
//	public static final double overbookingTimeWindowNumPoints = 10;	// How many points to track
	...
	public static double TIME_OUT = 10; //Double.POSITIVE_INFINITY; //
